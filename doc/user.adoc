...
the instructions given below.  These files may be places anywhere on
your hard drive, provided that you provide the correct to the customized
file(s) using the `-s` and `-S` <<cmdline-opts,command line options>>.
